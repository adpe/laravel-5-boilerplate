...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'plugins' => [
            'title'     => 'Moodle Plugins Overview',
            'intro'     => 'Here you can find a table with all plugins.'
        ]
    ],
    ...
    'frontend' => [
        ...
        'plugins' => [
            'overview' => 'Moodle Plugins Overview',
            'intro' => 'Please login to access the overview.',
            'button' => 'See all',
        ],
    ],
];
