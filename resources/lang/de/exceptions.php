    ...
    'backend' => [
        'access' => [
            ...
            'users' => [
                ...
                'email_error'           => 'Diese E-Mail Adresse ist einem anderem Benutzer zugeordnet.',
    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resent'            => 'Eine neue Aktivierungsmail wurde an die hinterlegte E-Mail Adresse gesendet.',
            ],
